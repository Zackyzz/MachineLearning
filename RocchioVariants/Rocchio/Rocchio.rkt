...
(define train-set (change-class (change-class (file-lines->list "train-xor.txt") 2 2) 3 3))
(define test-set (change-class (change-class (file-lines->list "test-xor.txt") 2 2) 3 3))
...
(define test-all (time (map (λ(x) (cons (apply-rocchio trained x) x)) all-points)))
