...
(define temp-train
  (map normalize (change-class (change-class (file-lines->list "train-xor.txt") 2 1) 3 0)))
(define temp-test
  (map normalize (change-class (change-class (file-lines->list "test-xor.txt") 2 1) 3 0)))
